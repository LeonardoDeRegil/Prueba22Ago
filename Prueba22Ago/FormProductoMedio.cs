...
{
    public partial class FormProductoMedio : Form
    {
        public FormProductoMedio()
        {
            InitializeComponent();
        }
        ...
        private void btnEjecutar_Click(object sender, EventArgs e)
        {
            ...
            if (n1 <= 99 || n1 > 999)
            {
                MessageBox.Show("El valor de n+1 tiene que ser de TRES digitos.");
                return;
            }

            // Paso 2: Declarar clase algoritmo genético
            AlgoritmoProductoMedio algoritmo = new AlgoritmoProductoMedio();

            // Paso 3: Llamar método principal
            List<int> listaEnteros = algoritmo.GeneradorProductoMedio(n, n1);
